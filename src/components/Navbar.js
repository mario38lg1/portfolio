...
function NavBar() {
  ...
  return (
    ...
    >
      <Container>
        <Navbar.Brand href="/" className="d-flex" aria-label="brand">
          <svg
          ...
          >
            ...
            <text
              ...
              y="58"
              textAnchor="middle"
              style={{ fontFamily: "inherit", fontWeight: 700, fontSize: "54px", fill: "currentColor" }}
            >
              ML
            </text>
          </svg>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="ms-auto" defaultActiveKey="#home">
            ...
            {/* Blogs removed per user request */}

            <Nav.Item className="fork-btn">
              <Button
                href="https://github.com/mario38lg1"
                target="_blank"
